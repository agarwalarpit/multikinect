...
class CL:
    ...
    def popCorn(self, array_1, array_2):
        mf = cl.mem_flags

        #initialize client side (CPU) arrays
        self.a = numpy.array(array_1, dtype=numpy.float32)
        self.b = numpy.array(array_2, dtype=numpy.float32)
...
if __name__ == "__main__":
    ...
    example.popCorn(range(10), range(10))
    example.execute()
